...
for stock in stocks.code.tolist():
    try:
        candles = qa.QA_fetch_stock_day_adv(stock, start='2016-01-01', end='2018-04-25')
...
train.to_csv('../data/train_16_17.csv', index=False)
test.to_csv('../data/test_16_17.csv', index=False)
